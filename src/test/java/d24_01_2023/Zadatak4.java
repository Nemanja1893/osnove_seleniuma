...
//        Na kraju programa ugasite pretrazivac.
        ...
        for (int i = 0; i < 5; i++) {
            ...
            driver.findElement(By.name("department")).sendKeys("Tester");
            driver.findElement(By.name("phone")).sendKeys("(358) 564-4785");

            driver.findElement(By.xpath("//*[@class ='table table-bordered']/tbody//" +
                    "*[last()]//td[last()]/*[@class = 'add']")).click();
